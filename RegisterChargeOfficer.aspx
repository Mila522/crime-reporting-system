vcv<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterChargeOfficer.aspx.cs" Inherits="ComplaintSystem.RegisterChargeOfficer" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Register Charge Officer</title>
...
<body>
    <form id="form1" runat="server">
        <div class="register-container">
            <h2>Register as Charge Officer</h2>
            <div class="form-group">
                ...
                <asp:RequiredFieldValidator ID="rfvOfficerID" runat="server" ControlToValidate="txtOfficerID" 
                    ErrorMessage="Officer ID is required." CssClass="error" Display="Dynamic" />
            </div>
            <div class="form-group">
